                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store', $camps->id)}}" class="basic-form" method="post">
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number" maxlength="3" class="form-control {{$errors->has('cvc') ? 'is-invalid' : ''}}" required/>
                                            @if($errors->has('cvc'))
                                                <div class="text-danger">
                                                    {{$errors->first('cvc')}}
                                                </div>
                                ...
                                <p class="text-center subheader mt-4">
                                    <img src="{{asset('images/ic_secure.svg.png')}}" alt=""> Your payment is secure and encrypted.
                                </p>
                            </form>
                        </div>
                    </div>
